...
Результат доступен по адресу [http://localhost:8080](http://localhost:8080) или [http://localhost:3000](http://localhost:3000).
...
1. Клонировать репозиторий:
   ```bash
   git clone https://github.com/MintCmd/web-labs.git
   cd nginx-lab
...
```code/about.html``` — доп. страница с описанием
